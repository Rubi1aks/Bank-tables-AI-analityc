            ...
            <Card>
                ...
                <CardBody>
                    <EmptyState
                        ...
                        description="Выберите сценарий, чтобы увидеть распределение по субъектам РФ."
                    />
                </CardBody>
            </Card>
        )
        ...
        <Card>
            ...
            <CardBody className="space-y-4">
                ...
                <p className="text-[11px] text-text-muted">
                    Интенсивность заливки пропорциональна значению показателя. Схематичная картограмма по субъектам РФ.
                </p>
            </CardBody>
        </Card>
    )
